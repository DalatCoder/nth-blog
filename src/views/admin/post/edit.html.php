    ...
    <div class="row">
            ...
            <div class="card card-primary">
                ...
                <div class="card-body" style="display: block;">
                    <div class="form-group">
                        ...
                        <input type="text" id="title" class="form-control" name="title" form="post-form" value="<?= $post->{\NTHB\Entity\PostEntity::KEY_TITLE} ?>">
                    </div>
                    <div class="form-group">
                        <label for="meta-title">SEO Meta</label>
                        <input type="text" id="meta-title" class="form-control" name="meta-title" form="post-form" value="<?= $post->{\NTHB\Entity\PostEntity::KEY_META_TITLE} ?>">
                    </div>
                    <div class="form-group">
                        <label for="summary">Tóm tắt</label>
                        <textarea id="summary" class="form-control" rows="4" name="summary" form="post-form"><?= $post->{\NTHB\Entity\PostEntity::KEY_SUMMARY} ?></textarea>
                    </div>
                    <div class="form-group">
                        ...
                        <select id="parent-id" class="form-control select2 parent-id-select2" style="width: 100%;" name="parent-id" form="post-form">
                            ...
                            <?php foreach ($posts as $p): ?>
                                <option 
                                    value="<?= $p->{\NTHB\Entity\PostEntity::KEY_ID} ?>"
                                    selected="<?= $p->id == $post->{\NTHB\Entity\PostEntity::KEY_PARENT_ID} ? 'selected' : '' ?>"
                                ><?= $p->{\NTHB\Entity\PostEntity::KEY_TITLE} ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        >
                            <?php foreach ($categories as $category): ?>
                                <option 
                                    value="<?= $category->{\NTHB\Entity\CategoryEntity::KEY_ID} ?>"
                                    selected="<?= $post->belong_to_category($category->id) ? 'selected' : '' ?>"
                                ><?= $category->{\NTHB\Entity\CategoryEntity::KEY_TITLE} ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <hr>
                    ...
                    <div class="form-group">
                        ...
                        >
                            <?php foreach ($tags as $tag): ?>
                                <option 
                                    value="<?= $tag->{\NTHB\Entity\TagEntity::KEY_ID} ?>"
                                    selected="<?= $post->belong_to_tag($tag->id) ? 'selected' : '' ?>"
                                ><?= $tag->{\NTHB\Entity\TagEntity::KEY_TITLE} ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <hr>
        ...
        <div class="col-12">
            <div class="card card-outline card-info">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <textarea id="summernote" name="content" form="post-form"><?= $post->{\NTHB\Entity\PostEntity::KEY_CONTENT} ?></textarea>
                </div>
