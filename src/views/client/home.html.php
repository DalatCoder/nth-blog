...
<div class="row">
    ...
    <section class="col-xs-12 col-sm-6 col-md-6 col-lg-6 grid">
        <figure class="effect-oscar">
            <img src="/static/avana/images/home-images/image-1.jpg" alt="" class="img-responsive"/>
            <figcaption>
    ...
    <section class="col-xs-12 col-sm-6 col-md-6 col-lg-6 grid">
        <ul class="grid-lod effect-2" id="grid">
            <li>
                <figure class="effect-oscar">
                    <img src="/static/avana/images/home-images/image-2.jpg" alt="" class="img-responsive"/>
                    <figcaption>
            ...
            <li>
                <figure class="effect-oscar">
                    <img src="/static/avana/images/home-images/image-4.jpg" alt="" class="img-responsive"/>
                    <figcaption>
    ...
    <section class="col-xs-12 col-sm-6 col-md-6 col-lg-6 grid">
        <ul class="grid-lod effect-2" id="grid">
            <li>
                <figure class="effect-oscar">
                    <img src="/static/avana/images/home-images/image-3.jpg" alt="" class="img-responsive"/>
                    <figcaption>
            ...
            <li>
                <figure class="effect-oscar">
                    <img src="/static/avana/images/home-images/image-5.jpg" alt="" class="img-responsive"/>
                    <figcaption>
                        <h2>A Brand <span>new Agency</span></h2>
                        <p>Over 40,000 customers use our themes to power their</p>
                        <a href="works-details.html">View more</a>
